...
const catppuccinMocha: Theme = {
  ...
  colors: {
    ...
    '--accent-red-bg': 'rgba(243, 139, 168, 0.1)',
    '--accent-blue-bg': 'rgba(137, 180, 250, 0.1)',
...
const catppuccinLatte: Theme = {
  ...
  colors: {
    ...
    '--accent-red-bg': 'rgba(210, 15, 57, 0.1)',
    '--accent-blue-bg': 'rgba(30, 102, 245, 0.1)',
...
const dracula: Theme = {
  ...
  colors: {
    ...
    '--accent-red-bg': 'rgba(255, 85, 85, 0.1)',
    '--accent-blue-bg': 'rgba(139, 233, 253, 0.1)',
...
const oneDark: Theme = {
  ...
  colors: {
    ...
    '--accent-red-bg': 'rgba(224, 108, 117, 0.1)',
    '--accent-blue-bg': 'rgba(97, 175, 239, 0.1)',
...
const solarizedDark: Theme = {
  ...
  colors: {
    ...
    '--accent-red-bg': 'rgba(220, 50, 47, 0.1)',
    '--accent-blue-bg': 'rgba(38, 139, 210, 0.1)',
